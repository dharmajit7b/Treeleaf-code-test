...
// I      JWT in context of USER, ROLE, and PERMISSIONS
package com.treeleaf.code.controller;


import com.treeleaf.code.common.UserConstant;
import com.treeleaf.code.entity.User;
import com.treeleaf.code.repository.UserRepository;
...
public class UserController {
    ...
    public String giveAccessToUser(@PathVariable int userId, @PathVariable String userRole, Principal principal) {
        User user = (User) repository.findById(userId).get();
    ...
    private List<String> getRolesByLoggedInUser(Principal principal) {
        ...
        if (assignRoles.contains("MONITOR")) {
            return Arrays.stream(UserConstant.MONITOR_ACCESS).collect(Collectors.toList());
        }
